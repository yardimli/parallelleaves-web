...
async function handleToolbarAction(button) {
	...
	if (button.classList.contains('js-ai-action-btn')) {
		...
		const context = {
			...
			languageForPrompt: typeof toolbarConfig.getTargetLanguage === 'function' ? toolbarConfig.getTargetLanguage() : 'Translation',
			targetLanguage: typeof toolbarConfig.getTargetLanguage === 'function' ? toolbarConfig.getTargetLanguage() : 'Translation',
