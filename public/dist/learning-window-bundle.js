(() => {
  ...
  var startBtn = document.getElementById("js-start-learning-btn");
  var stopBtn = document.getElementById("js-stop-learning-btn");
  var editor = document.getElementById("js-learning-results-editor");
  ...
  var debouncedSave = debounce(saveInstructions, 5e3);
