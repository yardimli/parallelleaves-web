...
const API_ENDPOINTS = {
	...
	'tm:purgeRow': '/api/translation-memory/purge-row',
	...
	'codex:compact': '/api/codex/compact',
...
window.api = {
	...
	purgeTmRow: (id, rule, model) => rpcInvoke('tm:purgeRow', id, rule, model),
	...
	compactCodex: (bookId, data) => rpcInvoke('codex:compact', bookId, data),
